...
INSERT INTO `sys_commodity` VALUES ('生活001', '防紫外线伞', 100, 99, 5, '临时用伞', 2, 4.5, 'https://gitee.com/Robot_Kevin/TypeChoImg/raw/master/cct/1621874745440.jpg', 1621874739991, 1621875251069, 'buyer', b'1', NULL, NULL, NULL);
...
CREATE TABLE `sys_order` (
  ...
  `orderBuyStatus` int NOT NULL COMMENT '付款状态\n1：已付款\n2：未付款',
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES ('admin', 'admin', 'admin', '男', '13506839371', '845923059@qq.com', '您的大学叫什么？', '科艺', 'https://gitee.com/Robot_Kevin/TypeChoImg/raw/master/cct/1621873483819.jpg', 1622135118372, 1621700765210, 1621873487075, 'admin', b'1', NULL, NULL, NULL);
