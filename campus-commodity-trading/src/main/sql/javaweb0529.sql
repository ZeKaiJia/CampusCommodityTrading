...
CREATE TABLE `sec_block_chain` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '序号',
  `data` varchar(191) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '数据',
  `hash` varchar(191) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '哈希值',
  `previousHash` varchar(191) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '上一个区块哈希值',
