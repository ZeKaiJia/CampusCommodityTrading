...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` (`userName`, `userPassword`, `userNick`, `userGender`, `userPhone`, `userEmail`, `userQuest`, `userAnswer`, `userAvatar`, `userLastLogin`, `utcCreate`, `utcModify`, `modifyBy`, `valid`, `remark`, `customa`, `customb`) VALUES ('admin', 'admin', 'admin', '男', '13506839371', '845923059@qq.com', '您的大学叫什么？', '科艺', 'https://gitee.com/Robot_Kevin/TypeChoImg/raw/master/cct/1621873483819.jpg', 1622467642518, 1621700765210, 1622427713723, 'admin', b'1', NULL, NULL, NULL), ('buyer', 'admin', '承租方', '女', '13565120077', 'hxy1999@gmail.com', '您最好的朋友叫什么？', '贾泽楷', NULL, 1622465477651, 1621873543898, 1621873543898, 'admin', b'1', NULL, NULL, NULL), ('buyer2', 'admin', '承租方2', '女', '13459834838', '2@qq.com', '您的大学叫什么？', '科艺', NULL, 1621875471676, 1621873937734, 1621875584846, 'admin', b'1', NULL, NULL, NULL), ('saler', 'admin', '出租方', '男', '13506839372', '888888888@qq.com', '您的大学叫什么？', '科艺', 'https://gitee.com/Robot_Kevin/TypeChoImg/raw/master/cct/1621873980422.png', 1622379688719, 1621873454905, 1621873982071, 'saler', b'1', NULL, NULL, NULL), ('saler2', 'admin', '出租方2', '男', '13311111111', '121212@11.com', '您的大学叫什么？', '科艺', 'https://gitee.com/Robot_Kevin/TypeChoImg/raw/master/cct/1621874549792.jpeg', 1621875329870, 1621873918374, 1621875604877, 'admin', b'1', NULL, NULL, NULL), ('test', 'admin', '测试用户', '男', '13509090909', 'oxoxoxoxoxo@163.com', '您的电子邮箱是？', 'oxoxoxoxoxo@163.com', NULL, NULL, 1621873643774, 1621873643774, 'admin', b'1', NULL, NULL, NULL);
COMMIT;
...
ON SCHEDULE
EVERY '1' DAY STARTS '2021-06-02 06:00:00'
DO CALL resetSQL()
;;
delimiter ;
