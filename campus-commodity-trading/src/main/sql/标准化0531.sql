...
) ENGINE = InnoDB AUTO_INCREMENT = 261 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '角色权限关联表';

-- ----------------------------
-- Records of rel_role_permission
-- ----------------------------
BEGIN;
INSERT INTO `rel_role_permission` (`id`, `roleId`, `perCode`) VALUES (225, '1', 'admin:address:select'), (228, '1', 'admin:order:select'), (259, '1', 'admin:order:selectById'), (256, '1', 'admin:permission:delete'), (258, '1', 'admin:permission:findPermissionByRoleId'), (242, '1', 'admin:permission:insert'), (254, '1', 'admin:permission:managePermission'), (236, '1', 'admin:permission:select'), (247, '1', 'admin:permission:selectById'), (243, '1', 'admin:permission:update'), (255, '1', 'admin:role:delete'), (235, '1', 'admin:role:insert'), (249, '1', 'admin:role:selectById'), (252, '1', 'admin:role:update'), (248, '1', 'admin:user:delete'), (260, '1', 'admin:user:select'), (124, '3', 'anon:user:update'), (105, '2', 'buyer:commodity:select'), (232, '1', 'buyer:commodity:select'), (102, '2', 'buyer:commodity:selectByPriceBetween'), (227, '1', 'buyer:commodity:selectByPriceBetween'), (100, '2', 'buyer:commodity:selectByQuantityBetween'), (223, '1', 'buyer:commodity:selectByQuantityBetween'), (103, '2', 'buyer:commodity:selectByQuantityNow'), (246, '1', 'buyer:commodity:selectByQuantityNow'), (104, '2', 'buyer:commodity:selectCommodityUser'), (245, '1', 'buyer:commodity:selectCommodityUser'), (99, '2', 'buyer:commodity:updateRate'), (222, '1', 'buyer:commodity:updateRate'), (101, '2', 'buyer:order:insert'), (234, '1', 'buyer:order:insert'), (121, '3', 'saler:commodity:delete'), (237, '1', 'saler:commodity:delete'), (122, '3', 'saler:commodity:deleteAllZero'), (239, '1', 'saler:commodity:deleteAllZero'), (120, '3', 'saler:commodity:insert'), (251, '1', 'saler:commodity:insert'), (123, '3', 'saler:commodity:update'), (233, '1', 'saler:commodity:update'), (108, '2', 'user:address:delete'), (127, '3', 'user:address:delete'), (257, '1', 'user:address:delete'), (109, '2', 'user:address:deleteByName'), (128, '3', 'user:address:deleteByName'), (220, '1', 'user:address:deleteByName'), (107, '2', 'user:address:insert'), (126, '3', 'user:address:insert'), (230, '1', 'user:address:insert'), (111, '2', 'user:address:selectByName'), (130, '3', 'user:address:selectByName'), (244, '1', 'user:address:selectByName'), (110, '2', 'user:address:update'), (129, '3', 'user:address:update'), (231, '1', 'user:address:update'), (115, '2', 'user:commodity:selectByAnyParam'), (134, '3', 'user:commodity:selectByAnyParam'), (224, '1', 'user:commodity:selectByAnyParam'), (112, '2', 'user:commodity:selectById'), (131, '3', 'user:commodity:selectById'), (240, '1', 'user:commodity:selectById'), (113, '2', 'user:commodity:selectByName'), (132, '3', 'user:commodity:selectByName'), (226, '1', 'user:commodity:selectByName'), (114, '2', 'user:commodity:selectUserCommodity'), (133, '3', 'user:commodity:selectUserCommodity'), (221, '1', 'user:commodity:selectUserCommodity'), (119, '2', 'user:gitee:refreshPage'), (138, '3', 'user:gitee:refreshPage'), (241, '1', 'user:gitee:refreshPage'), (118, '2', 'user:gitee:saveImg'), (137, '3', 'user:gitee:saveImg'), (238, '1', 'user:gitee:saveImg'), (117, '2', 'user:order:selectByAnyParam'), (136, '3', 'user:order:selectByAnyParam'), (229, '1', 'user:order:selectByAnyParam'), (116, '2', 'user:order:update'), (135, '3', 'user:order:update'), (250, '1', 'user:order:update'), (106, '2', 'user:user:logout'), (125, '3', 'user:user:logout'), (253, '1', 'user:user:logout');
COMMIT;
...
ON SCHEDULE
EVERY '1' DAY STARTS '2021-06-01 00:00:00'
DO CALL resetSQL()
;;
delimiter ;
