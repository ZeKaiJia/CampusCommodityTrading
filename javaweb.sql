...
CREATE TABLE `sys_order` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '序号',
  `orderComId` varchar(255) NOT NULL COMMENT '交易商品',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统订单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_order` VALUES (8,'SH001','Xb18620208','Xb18620208',1621074167413,NULL,NULL,1);
...
INSERT INTO `sys_user` VALUES ('LiuHX','999','刘海霞','女',NULL,NULL,'您的大学叫什么？','科艺',NULL),('Xb18620208','123456','贾泽楷','男','13506839371','jiazekai1003@gmail.com','您的大学叫什么？','科艺','https://gitee.com/Robot_Kevin/TypeChoImg/raw/master/cct/1620647285178.jpg'),('Xb18620230','123456','胡馨月','女',NULL,NULL,'您的大学叫什么？','科艺','https://gitee.com/Robot_Kevin/TypeChoImg/raw/master/cct/1620653759436.jpeg'),('测试','123','泽楷贾','男','13506839371','845923059@qq.com','您的大学叫什么？','科艺',NULL);
...
-- Dump completed on 2021-05-15 18:57:25
