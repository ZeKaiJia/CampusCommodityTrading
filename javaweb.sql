...
-- ----------------------------
BEGIN;
INSERT INTO `rel_user_commodity` VALUES (1, 'SH001', 'Xb18620208', 1);
INSERT INTO `rel_user_commodity` VALUES (2, 'SH002', 'Xb18620208', 2);
INSERT INTO `rel_user_commodity` VALUES (3, 'SH003', 'Xb18620208', 3);
INSERT INTO `rel_user_commodity` VALUES (4, 'SH004', 'Xb18620208', 4);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `rel_user_role` VALUES (10, 'Xb18620230', '2');
INSERT INTO `rel_user_role` VALUES (12, '测试', '2');
INSERT INTO `rel_user_role` VALUES (14, 'LiuHX', '3');
INSERT INTO `rel_user_role` VALUES (21, 'Xb18620208', '1');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_commodity` VALUES ('SH001', '扫把', 1, 1, 10, '一把破旧的扫把');
INSERT INTO `sys_commodity` VALUES ('SH002', '拖把', 2, 2, 20, '一把破旧的拖把');
INSERT INTO `sys_commodity` VALUES ('SH003', '帽子', 3, 3, 30, '一顶破旧的帽子');
INSERT INTO `sys_commodity` VALUES ('SH004', '靴子', 4, 4, 40, '一双破旧的靴子');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES ('LiuHX', '999', '刘海霞', '女', NULL, NULL, '您的姓名', '刘海霞');
INSERT INTO `sys_user` VALUES ('Xb18620208', '123456', '贾泽楷', '男', '13506839371', 'jiazekai1003@gmail.com', '您的姓名', '贾泽楷');
INSERT INTO `sys_user` VALUES ('Xb18620230', '123456', '胡馨月', '女', NULL, NULL, '您的姓名', '胡馨月');
INSERT INTO `sys_user` VALUES ('测试', '123', '泽楷贾', '男', '13506839371', '845923059@qq.com', '您的大学叫什么？', '科艺');
COMMIT;
